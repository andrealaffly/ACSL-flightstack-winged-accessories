% This function processes the log files for MRAC_OBSERVER
function [] = process_mrac_observer_log(flightRunNames,baseDir,controller,properties)
    ...
    for ii = 1:length(flightRunNames)
        ...
        gains_file_path = fullfile(baseDir,flightRunNames{ii}, controller, 'params', 'gains_MRAC_OBSERVER.json');
