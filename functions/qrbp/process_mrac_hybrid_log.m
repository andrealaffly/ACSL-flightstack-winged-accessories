...
function [] = process_mrac_hybrid_log(flightRunNames,baseDir,controller,properties)
    ...
    for ii = 1:length(flightRunNames)
        ...
        gains_file_path = fullfile(baseDir,flightRunNames{ii}, controller, 'params', 'gains_MRAC_HYBRID.json');
        ...
        log.hyrbid.tran.e_prev.x = data.data(:,321);
        log.hybrid.tran.e_prev.y = data.data(:,322);
        log.hybrid.tran.e_prev.z = data.data(:,323);
        log.hybrid.tran.e_prev.vx = data.data(:,324);
        log.hybrid.tran.e_prev.vy = data.data(:,325);
        log.hybrid.tran.e_prev.vz = data.data(:,326);

        log.hybrid.rot.e_prev.ox = data.data(:,327);
        log.hybrid.rot.e_prev.oy = data.data(:,328);
        log.hybrid.rot.e_prev.oz = data.data(:,329);

        log.hyrbid.tran.jump_map.x = data.data(:,321);
        log.hybrid.tran.jump_map.y = data.data(:,322);
        log.hybrid.tran.jump_map.z = data.data(:,323);
        log.hybrid.tran.jump_map.vx = data.data(:,324);
        log.hybrid.tran.jump_map.vy = data.data(:,325);
        log.hybrid.tran.jump_map.vz = data.data(:,326);

        log.hybrid.rot.jump_map.ox = data.data(:,327);
        log.hybrid.rot.jump_map.oy = data.data(:,328);
        log.hybrid.rot.jump_map.oz = data.data(:,329);

        log.hybrid.tran.e_transpose_Q_e = data.data(:,330);
        log.hybrid.tran.e_transpose_Q_e_I = data.data(:,331);
        log.hybrid.tran.summation_P  = data.data(:,332);
        log.hybrid.tran.s = data.data(:,333);
        log.hybrid.tran.s_element  = data.data(:,334);
        log.hybrid.tran.reset_time = data.data(:,335);
        log.hybrid.tran.hybrid_reset_condition_verified_flag = data.data(:,336);
        log.hybrid.tran.summation_condition_hybrid_verified_flag = data.data(:,337);

        log.hybrid.rot.e_transpose_Q_e = data.data(:,338);
        log.hybrid.rot.e_transpose_Q_e_I = data.data(:,339);
        log.hybrid.rot.summation_P = data.data(:,340);
        log.hybrid.rot.s = data.data(:,341);
        log.hybrid.rot.s_element = data.data(:,342);
        log.hybrid.rot.reset_time = data.data(:,343);
        log.hybrid.rot.hybrid_reset_condition_verified_flag = data.data(:,344);
        log.hybrid.rot.summation_condition_hybrid_verified_flag = data.data(:,345);
