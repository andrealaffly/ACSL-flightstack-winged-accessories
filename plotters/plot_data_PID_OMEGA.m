...
plotTranslationalXvsZ(log, 'PID - X vs Z position');
...
%% Angular velocity
plotAngularVelocitiesUserAndState(log, 'PID - Angular Velocities');

%% Error in Euler Angles and Angular velocities
plotErrAngleAngularVelocities(log, 'PID - Error In Euler Angle and Angular Velocities');
