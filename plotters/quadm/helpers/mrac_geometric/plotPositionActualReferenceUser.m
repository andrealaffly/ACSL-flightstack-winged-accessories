...
function [] = plotPositionActualReferenceUser(log, title);
...
hold on
plot(log.Controller_Time_s,log.x_ref,'b--','LineWidth',2)
...
hold on
plot(log.Controller_Time_s,log.y_ref,'b--','LineWidth',2)
...
hold on
plot(log.Controller_Time_s,log.z_ref,'b--','LineWidth',2)
