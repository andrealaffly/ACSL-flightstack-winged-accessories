%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function is used to plot the Outer loop Oberver Theta hat Y gains
% along with the projection operator
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = (1:length(m_ind))
    ...
    yline(der.outer_loop.observer.projection_operator.up_bound.Gamma_Theta, 'r--', 'LineWidth',2);
    yline(der.outer_loop.observer.projection_operator.lw_bound.Gamma_Theta, 'b-.', 'LineWidth',2);
    yline(-der.outer_loop.observer.projection_operator.up_bound.Gamma_Theta, 'r--', 'LineWidth',2);
    yline(-der.outer_loop.observer.projection_operator.lw_bound.Gamma_Theta, 'b-.', 'LineWidth',2);
    ...
    proj_op_activated =log.outer_loop.observer.proj_op_activated_Theta_hat_tran_observer_y;  % Boolean vector
