...
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_vs.error.phi_dot), 'c--', 'LineWidth',1.5)
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_2l_vs.error.phi_dot),   'g-',  'LineWidth',1.5)
hold off
...
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_vs.error.theta_dot), 'c--', 'LineWidth',1.5)
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_2l_vs.error.theta_dot),   'g-',  'LineWidth',1.5)
hold off
l = legend('MRAO', '2L MRAO', 'VS MRAO', '2L VS MRAO');
set(l,'interpreter','latex','fontsize',15);
...
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_vs.error.psi_dot), 'c--', 'LineWidth',1.5)
plot(log.Controller_Time_s, rad2deg(der.differentiator.mrad_2l_vs.error.psi_dot),   'g-',  'LineWidth',1.5)
hold off
l = legend('MRAO', '2L MRAO', 'VS MRAO', '2L VS MRAO');
set(l,'interpreter','latex','fontsize',15);
