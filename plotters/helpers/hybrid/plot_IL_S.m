...
function [] = plot_IL_S(log,title)

set(figure,'Color','White')

subplot(2,1,1)
plot(log.Controller_Time_s,log.hybrid.rot.s, 'b-', 'LineWidth',2)
...
subplot(2,1,2)
plot(log.Controller_Time_s,log.hybrid.rot.s_element,'r-', 'LineWidth',2)
plot_event_lines(log.Controller_Time_s, ...
                 log.hybrid.tran.hybrid_reset_condition_verified_flag, ...
                 'reset', 'k--');
plot_event_lines(log.Controller_Time_s, ...
