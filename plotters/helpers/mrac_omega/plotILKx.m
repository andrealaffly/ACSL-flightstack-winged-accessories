%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function is used to plot the Inner loop K hat X gains along with the 
% projection operator
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [] = plotILKx(log,der, title)
...
for i = (1:length(m_ind))
    ...
    yline(der.inner_loop.projection_operator.up_bound.x, 'r--', 'LineWidth',2);
    yline(der.inner_loop.projection_operator.lw_bound.x, 'b-.', 'LineWidth',2);
    yline(-der.inner_loop.projection_operator.up_bound.x, 'r--', 'LineWidth',2);
    yline(-der.inner_loop.projection_operator.lw_bound.x, 'b-.', 'LineWidth',2);
    ...
    proj_op_activated = log.proj_op_activated.inner_loop.K_hat_x;  % Boolean vector
